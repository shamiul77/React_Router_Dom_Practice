    ...
    <div  >
        <nav className="navbar bg-secondary px-5 py-3 sticky-top ">
            <div class="container-fluid d-flex">
                ...
                <a class="navbar-brand fs-2"><Link to="info" class="text-decoration-none text-white fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal">Informations</Link></a>
